...
class PlayState extends MusicBeatState
{
	...
	function set_health(value:Float):Float // You can alter how icon animations work here
	{
		...
		iconP1.animation.curAnim.curFrame = (healthBar.percent < 20) ? 1 : (iconP1.hasWinning && healthBar.percent > 80) ? 2 : 0;
		iconP2.animation.curAnim.curFrame = (healthBar.percent > 80) ? 1 : (iconP2.hasWinning && healthBar.percent < 20) ? 2 : 0;
		return health;
	}
